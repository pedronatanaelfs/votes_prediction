...
# Patch for gensim/scipy ImportError: cannot import name 'triu' from 'scipy.linalg'
# See: https://github.com/scipy/scipy/issues/18069 and https://github.com/RaRe-Technologies/gensim/issues/3529
import scipy
import sys
...
def download_nltk_resources():
    ...
    try:
        # Try to use stopwords to check if they're downloaded
...
def perform_clustering(vectors, n_clusters=None, max_clusters=20):
    """
    Perform clustering on document vectors using K-means.
    ...
    --------
    dict
        Dictionary with clustering results (kmeans only)
    """
...
def main(start_year=2003, end_year=2024, n_clusters=None, output_path=None, vector_size=100):
    ...
    if output_path is None:
        output_path = os.path.join("01 - Global Prediction\Content", "content_cluster.csv")
